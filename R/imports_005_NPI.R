...
plot_model_scenarios <- ggarrange(closing_borders_plot,scenarios_closure_afterconcern_plot, change_surveillance_plot,legend_voc,
                                  labels = c("A","B","C", ""),
                                  ncol = 2, nrow = 2)
ggsave(plot_model_scenarios, filename = paste0("./data/figures/Figure6_counterfactual_",format(Sys.time(), "%Y-%m-%d"), ".pdf"), height = 6, width = 8,  bg = "transparent")
ggsave(plot_model_scenarios, filename = paste0("./data/figures/Figure6_counterfactual_",format(Sys.time(), "%Y-%m-%d"), ".png"), height = 6, width = 8,  bg = "transparent")
ggsave(plot_model_scenarios, filename = paste0("./data/figures/Figure6_counterfactual_",format(Sys.time(), "%Y-%m-%d")), height =6, width = 8,  bg = "transparent",device='tiff', dpi=700)
